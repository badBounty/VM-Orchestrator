...
urlpatterns = [
    ...
    path('rcv_code_vulnerability_state/', views.rcv_code_vuln_state, name='rcv_code_vulnerability_state'),
    path('add_web_vulnerability', views.add_web_vuln, name='add_web_vulnerability'),
