...
def get_code_vulnerabilities_csv_file(resources):
    ...
    for resource in resources:
        resources_for_csv.append({
            ...
            'Line': resource['line'],
            'Affected Code': resource['affected_code'],
            'Firt Commit': resource['first_commit'],
            'Last Commit': resource['last_commit'],
            'Username': resource['username'],
            'Pipeline Name': resource['pipeline_name'],
            'Language': resource['language'],
            'Hash': resource['hash'],
            'Severity Tool': resource['severity_tool'],
